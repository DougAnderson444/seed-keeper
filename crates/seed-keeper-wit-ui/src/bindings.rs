    ...
    pub mod wit_ui {
      ...
      pub mod wurbo_out {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_render(arg0: i32,arg1: i32,arg2: i32,arg3: i32,arg4: i32,arg5: i32,arg6: i32,arg7: i32,arg8: i32,arg9: i32,) -> i32 {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
            ...
            use super::super::super::super::seed_keeper::wit_ui::wurbo_types::Context as V6;
            let v6 = match arg0 {
              0 => {
                let e6 = super::super::super::super::seed_keeper::wit_ui::wurbo_types::Content{
                  page: match arg1 {
                    0 => None,
                    1 => {
                      let e = {
              ...
              1 => {
                let e6 = {
                  let len3 = arg2 as usize;
                  let bytes3 = Vec::from_raw_parts(arg1 as *mut _, len3, len3);
