    ...
    pub mod edwards_ui {
        ...
        pub mod wurbo_in {
            ...
            pub type ListenDetails =
                super::super::super::example::edwards_ui::wurbo_types::ListenDetails;
...
pub mod seed_keeper {
    ...
    pub mod edwards_wit {
        ...
        pub mod operations {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn verify(message: &[u8], signature: &[u8]) -> Result<bool, _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
...
pub mod exports {
    ...
    pub mod example {
        ...
        pub mod edwards_ui {
            ...
            pub mod wurbo_out {
                ...
                pub type Context =
                    super::super::super::super::example::edwards_ui::wurbo_types::Context;
                #[doc(hidden)]
    ...
    ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
      ...
      #[export_name = "cabi_post_example:edwards-ui/wurbo-out@0.1.0#customize"]
...
macro_rules! __export_example_impl {
  ...
  $($path_to_types_root)*::exports::example::edwards_ui::wurbo_out::__export_example_edwards_ui_wurbo_out_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::example::edwards_ui::wurbo_out);
  )
}
#[doc(inline)]
...
y\x01\x04\x03\x01(seed-keeper:edwards-wit/operations@0.1.0\x05\0\x01B\x0e\x01r\x02\
...
ontext\x03\0\x0c\x03\x01$example:edwards-ui/wurbo-types@0.1.0\x05\x01\x02\x03\0\x01\
\x0elisten-details\x01B\x04\x02\x03\x02\x01\x02\x04\0\x0elisten-details\x03\0\0\x01\
@\x01\x07details\x01\x01\0\x04\0\x10addeventlistener\x01\x02\x03\x01!example:edw\
ards-ui/wurbo-in@0.1.0\x05\x03\x02\x03\0\x01\x07context\x01B\x0e\x02\x03\x02\x01\
\x04\x04\0\x07context\x03\0\0\x01ps\x01k\x02\x01@\x01\x09selectors\x03\x01\0\x04\
\0\x08activate\x01\x04\x01j\x01s\x01s\x01@\x01\x03ctx\x01\0\x05\x04\0\x06render\x01\
\x06\x01o\x02ss\x01p\x07\x01j\0\x01s\x01@\x01\x09templates\x08\0\x09\x04\0\x09cu\
stomize\x01\x0a\x04\x01\"example:edwards-ui/wurbo-out@0.1.0\x05\x05\x04\x01\x20e\
xample:edwards-ui/example@0.1.0\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0G\x09pro\
