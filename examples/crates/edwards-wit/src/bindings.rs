    ...
    pub mod seed_keeper {
        ...
        pub mod edwards_wit {
            ...
            pub mod operations {
                ...
                pub unsafe fn _export_sign_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let len0 = arg1;
                    let result1 = T::sign(_rt::Vec::from_raw_parts(arg0.cast(), len0, len0));
      ...
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
        ...
        unsafe extern "C" fn export_sign(arg0: *mut u8,arg1: usize,) -> *mut u8 {
        ...
        unsafe extern "C" fn export_verify(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,) -> *mut u8 {
          $($path_to_types)*::_export_verify_cabi::<$ty>(arg0, arg1, arg2, arg3)
        }
...
macro_rules! __export_example_impl {
  ...
  $($path_to_types_root)*::exports::seed_keeper::edwards_wit::operations::__export_seed_keeper_edwards_wit_operations_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::seed_keeper::edwards_wit::operations);
  )
}
#[doc(inline)]
...
\x03\x01\x1fseed-keeper:wallet/config@0.1.0\x05\x02\x01B\x07\x01p}\x01j\x01\0\x01\
s\x01@\x01\x07message\0\0\x01\x04\0\x04sign\x01\x02\x01j\x01\x7f\x01s\x01@\x02\x07\
message\0\x09signature\0\0\x03\x04\0\x06verify\x01\x04\x04\x01(seed-keeper:edwar\
ds-wit/operations@0.1.0\x05\x03\x04\x01%seed-keeper:edwards-wit/example@0.1.0\x04\
